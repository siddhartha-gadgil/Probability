...
\input{Auxiliaryfiles/mypreamble_2018}
...
$$
\end{question}
In actual testing claims of psychics, the deck of cards used is not the standard deck of playing card, but what are called ``Zener cards'', shown below in the figure.  Professor Trelawney guessed 8 cards correctly. Are you impressed? If not, what would it take to impress you enough to become her disciple?
\begin{figure}[h]
\includegraphics[scale=0.8]{Figures/Zener_cards}
\caption{Zener cards: A deck of 25 card consisting of 5 cards each of the 5 different types shown here. The experiment consists in guessing the type of each card in  a shuffled deck. } 
\end{figure}
\eeg
...
\begin{figure}[h]
\includegraphics[scale=0.25]{Figures/Ingrid_Bergman}  $\stackrel{ ?}{\longrightarrow}$  \includegraphics[scale=0.30]{Figures/Isabella_Rossellini} $\stackrel{ ?}{\longleftarrow}$\;\;\;\;\;
\;\;\includegraphics[scale=0.27]{Figures/Greta_Garbo}\;\;\;\;\; \\

\vspace{2mm}
\includegraphics[scale=0.95]{Figures/Rosa_Parks}\;\;\;\;\;\;\;\; $\stackrel{ ?}{\longrightarrow}$  \includegraphics[scale=0.62]{Figures/Aung_San_Suu_Kyi} $\stackrel{ ?}{\longleftarrow}$ \;\;\;\;\;\; \includegraphics[scale=0.20]{Figures/Khin_Kyi} \\

\vspace{2mm}
\includegraphics[scale=0.25]{Figures/sparrow1} $\stackrel{ ?}{\longrightarrow}$  \includegraphics[scale=0.25]{Figures/sparrow2} $\stackrel{ ?}{\longleftarrow}$  \includegraphics[scale=0.25]{Figures/sparrow3}

\caption{Three cases for King Solomon. In each case, guess which of the two extreme pictures is the mother of the middle one. Some cases are easier than the others. If it is trivially easy or impossibly hard, there is no uncertainty involved.}
\end{figure}   
...
\includegraphics[scale=0.3]{Figures/birthdaysUS1969to1988}
...
\begin{figure}
\includegraphics[scale=1.2]{Figures/bayesparadox.pdf}
...
\begin{figure}
\includegraphics[scale=0.9]{Figures/binomial20halfpmfand400datapts.pdf}
...
\begin{figure}
\includegraphics[scale=1.2]{Figures/poisson2andhalfpmfbarchartanddata100}
...
\eeg
\begin{figure}
\includegraphics[scale=1]{Figures/exponentialpdfandcdf123}
...
\begin{figure}
\includegraphics[scale=1.3]{Figures/normalpdfandcdf12half}
...
\begin{figure}
\includegraphics[scale=1]{Figures/gammapdfandcdf123}
...
\begin{figure}
\includegraphics[scale=1]{Figures/birthdayparadoxhist}
...
\begin{figure}
\includegraphics[scale=1]{Figures/divergentsequencerearrangement} \\
\includegraphics[scale=1]{Figures/convergentsequencerearrangementzeta2} \\
